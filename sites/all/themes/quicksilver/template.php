<?php
// $Id: template.php,v 1.1 2009/06/12 06:47:41 agileware Exp $
...
function autodealer_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function quicksilver_menu_local_task($link, $active = FALSE) {
...
function quicksilver_breadcrumb($breadcrumb) {
...
function quicksilver_comment_wrapper($content, $type = null) {
  static $node_type;
  if (isset($type)) $node_type = $type;
  return '<div id="comments">' . $content . '</div>';
}

function quicksilver_menu_local_tasks() {
  $output = '';
 ...
 * @ingroup themeable
 */
function quicksilver_button($element) {
...
*/
function quicksilver_img_assist_page($content, $attributes = NULL) {
